...
export const SeverityDot = memo(function SeverityDot({ score, severity, className = '' }) {
  const level = severity || classifyBySeverity(score)
  const config = SEVERITY_CONFIG[level] || SEVERITY_CONFIG.info
...
export const SeverityBar = memo(function SeverityBar({ score, className = '' }) {
...
export const EPSSBadge = memo(function EPSSBadge({ score, percentile, className = '' }) {
