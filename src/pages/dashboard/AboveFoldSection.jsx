    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">Real-time cyber threat intelligence overview</p>
        </div>
        {lastSync && (
      ...
      {aiSummary && (
        <div className="bg-cyber-accent/10 border border-cyber-accent/30 rounded-lg p-3 sm:p-4">
          <div className="flex items-center gap-2 mb-2">
            <svg
              className="w-5 h-5 text-cyber-accent flex-shrink-0"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <div className="bg-red-900/20 border border-red-800/50 rounded-lg p-3 sm:p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs text-gray-500">
              ({escalatingActors.length} actors with increasing activity)
            </span>
          </div>
