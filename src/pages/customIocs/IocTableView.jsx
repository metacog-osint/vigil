      ...
      <table className="w-full">
        <thead className="bg-gray-900/50">
          <tr>
            ...
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase">Threat</th>
        ...
        <tbody className="divide-y divide-gray-800">
          {iocs.map(ioc => (
            <tr key={ioc.id} className="hover:bg-gray-800/50">
              ...
              <td className="px-4 py-3">
                <span className={`px-2 py-1 rounded text-xs bg-${IOC_TYPES[ioc.ioc_type]?.color || 'gray'}-500/20 text-${IOC_TYPES[ioc.ioc_type]?.color || 'gray'}-400`}>
                  ...
                  <div className="w-12 bg-gray-700 rounded-full h-2">
                    <div
                      className={`h-2 rounded-full ${
                        ...
                        ioc.confidence >= 50 ? 'bg-yellow-500' : 'bg-red-500'
                      }`}
