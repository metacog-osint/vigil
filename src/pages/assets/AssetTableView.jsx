      ...
      <table className="w-full">
        <thead className="bg-gray-900/50">
          <tr>
            ...
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase">Criticality</th>
        ...
        <tbody className="divide-y divide-gray-800">
          {assets.map(asset => (
            ...
            >
              ...
              <td className="px-4 py-3">
                <span className={`inline-flex items-center gap-1 px-2 py-1 rounded text-xs bg-${ASSET_TYPES[asset.asset_type]?.color || 'gray'}-500/20 text-${ASSET_TYPES[asset.asset_type]?.color || 'gray'}-400`}>
              ...
              <td className="px-4 py-3 text-right">
                <button
                  onClick={(e) => { e.stopPropagation(); onToggleMonitoring(asset.id, !asset.is_monitored) }}
