 ...
 * Custom IOCs Page
 *
 * Extracted components in ./customIocs/:
 * - useIocData.js: Data loading and action hooks
...
export default function CustomIOCs() {
  const { user } = useAuth()
            ...
            <>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-2">
                  <button onClick={() => setShowImportModal(true)} className="cyber-button text-sm">
                    <svg
