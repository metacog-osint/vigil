...
export default function Techniques() {
  ...
  async function loadActorTechniques() {
    try {
      const { data } = await supabase.from('actor_techniques').select('technique_id')
              ...
              <div className="space-y-4 text-sm">
                ...
                {selectedTechnique.platforms?.length > 0 && (
                  <div>
                    ...
                    <div className="text-gray-300">{selectedTechnique.platforms.join(', ')}</div>
                  </div>
                )}
                ...
                <div className="pt-4 border-t border-gray-800">
                  <a
                    href={
                      ...
                      `https://attack.mitre.org/techniques/${selectedTechnique.id.replace('.', '/')}/`
                    }
                    target="_blank"
