...
**Design approach:** Uses the Vigil eye icon PNG hosted on our domain, basic tables, and inline styles. The image is at `https://vigil.theintelligence.company/vigil-eye-icon.png`.
